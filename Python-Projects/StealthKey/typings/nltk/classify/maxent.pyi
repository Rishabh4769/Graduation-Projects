...
class MaxentClassifier(ClassifierI):
    ...
    ALGORITHMS = ...
    @classmethod
    def train(cls, train_toks, algorithm=..., trace=..., encoding=..., labels=..., gaussian_prior_sigma=..., **cutoffs): # -> ConditionalExponentialClassifier | TadmMaxentClassifier:
        """
...
def train_maxent_classifier_with_iis(train_toks, trace=..., encoding=..., labels=..., **cutoffs): # -> ConditionalExponentialClassifier:
    """
    Train a new ``ConditionalExponentialClassifier``, using the given
...
def load_maxent_params(tab_dir): # -> tuple[Any, dict[tuple[Any, int | Any | bool | None, Any], int], list[Any], dict[Any, int]]:
    ...
