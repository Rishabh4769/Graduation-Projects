...
class ClosedDomainProver(ProverCommandDecorator):
    ...
    proving.
    """
    def assumptions(self): # -> list[Any | AndExpression | BooleanExpression | NegatedExpression]:
        ...
    
    def goal(self): # -> AndExpression | BooleanExpression | NegatedExpression:
        ...
    
    def replace_quants(self, ex, domain): # -> AndExpression | BooleanExpression | NegatedExpression:
        """
