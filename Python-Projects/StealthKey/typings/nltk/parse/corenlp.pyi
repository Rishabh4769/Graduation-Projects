...
class GenericCoreNLPParser(ParserI, TokenizerI, TaggerI):
    ...
    def tag_sents(self, sentences, properties=...): # -> list[list[tuple[Any, Any]]]:
        """
    ...
    def tag(self, sentence: str, properties=...) -> list[tuple[str, str]]:
        """
    ...
    def raw_tag_sents(self, sentences, properties=...): # -> Generator[list[list[tuple[Any, Any]]], Any, None]:
        """
        Tag multiple sentences.
