...
class LogicParser:
    ...
    def handle(self, tok, context): # -> ApplicationExpression | IndividualVariableExpression | FunctionVariableExpression | EventVariableExpression | ConstantExpression | NegatedExpression | LambdaExpression | AllExpression | ExistsExpression | IotaExpression | AndExpression | IffExpression | ImpExpression | OrExpression | None:
    ...
    def handle_open(self, tok, context): # -> AndExpression | IffExpression | ImpExpression | OrExpression:
        ...
