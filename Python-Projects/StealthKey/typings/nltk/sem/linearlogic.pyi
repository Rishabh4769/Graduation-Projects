...
class LinearLogicParser(LogicParser):
    ...
    def handle(self, tok, context): # -> ApplicationExpression | IndividualVariableExpression | FunctionVariableExpression | EventVariableExpression | ConstantExpression | AndExpression | IffExpression | ImpExpression | OrExpression | None:
        ...
