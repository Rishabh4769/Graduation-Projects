...
class Boxer:
    ...
    def interpret_sents(self, inputs, discourse_ids=..., question=..., verbose=...): # -> list[Any | None]:
        """
        Use Boxer to give a first order representation.
    ...
    def interpret_multi_sents(self, inputs, discourse_ids=..., question=..., verbose=...): # -> list[Any | None]:
        """
        Use Boxer to give a first order representation.
