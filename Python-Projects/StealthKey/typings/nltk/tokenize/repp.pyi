...
class ReppTokenizer(TokenizerI):
    ...
    def tokenize(self, sentence): # -> tuple[Any, ...] | list[tuple[Any, int, int]]:
        """
    ...
    def tokenize_sents(self, sentences, keep_token_positions=...): # -> Generator[tuple[Any, ...] | list[tuple[Any, int, int]], Any, None]:
        """
