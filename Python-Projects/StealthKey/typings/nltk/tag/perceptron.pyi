...
class PerceptronTagger(TaggerI):
    ...
    START = ...
    END = ...
    def __init__(self, load=..., lang=..., loc=...) -> None:
        """
        :param load: Load the json model upon instantiation.
        """
        ...
    
    def param_files(self, lang=...): # -> Generator[str, None, None]:
        ...
    ...
    def save_to_json(self, lang=..., loc=...): # -> None:
        ...
    
    def load_from_json(self, lang=..., loc=...): # -> None:
        ...
    
    def decode_json_params(self, params): # -> None:
        ...
