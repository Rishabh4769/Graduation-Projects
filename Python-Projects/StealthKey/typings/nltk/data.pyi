...
def split_resource_url(resource_url): # -> tuple[Literal['file'], str] | tuple[Any | Literal['nltk', 'file'], Any | str]:
    """
...
class FileSystemPathPointer(PathPointer, str):
    ...
    def open(self, encoding=...): # -> SeekableUnicodeStreamReader | IO[Any]:
        """
...
_resource_cache = ...
def open_datafile(path, file_name=..., encoding=...):
    """
...
def load(resource_url, format=..., cache=..., verbose=..., logic_parser=..., fstruct_reader=..., encoding=...): # -> PunktTokenizer | Maxent_NE_Chunker | ClassifierBasedPOSTagger | PerceptronTagger | Any | CFG | PCFG | FeatureGrammar | list[Any] | Valuation:
    """
