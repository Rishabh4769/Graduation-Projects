...
class OpinionLexiconCorpusReader(WordListCorpusReader):
    ...
    def positive(self): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
    ...
    def negative(self): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
