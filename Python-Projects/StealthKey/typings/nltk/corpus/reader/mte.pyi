...
class MTECorpusView(XMLCorpusView):
    ...
    def read_block(self, stream, tagspec=..., elt_handler=...): # -> list[Element[str] | Any]:
        ...
...
class MTECorpusReader(TaggedCorpusReader):
    ...
    def lemma_words(self, fileids=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
        :param fileids: A list specifying the fileids that should be used.
    ...
    def tagged_words(self, fileids=..., tagset=..., tags=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str] | None:
        """
        :param fileids: A list specifying the fileids that should be used.
    ...
    def lemma_sents(self, fileids=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
        :param fileids: A list specifying the fileids that should be used.
    ...
    def tagged_sents(self, fileids=..., tagset=..., tags=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str] | None:
        """
        :param fileids: A list specifying the fileids that should be used.
        :param tagset: The tagset that should be used in the returned object,
                       either "universal" or "msd", "msd" is the default
    ...
    def lemma_paras(self, fileids=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
        :param fileids: A list specifying the fileids that should be used.
    ...
    def tagged_paras(self, fileids=..., tagset=..., tags=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str] | None:
        """
        :param fileids: A list specifying the fileids that should be used.
        :param tagset: The tagset that should be used in the returned object,
                       either "universal" or "msd", "msd" is the default
