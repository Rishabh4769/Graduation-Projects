...
class CorpusReader:
    ...
    def readme(self): # -> bytes | Any | str:
        """
        Return the contents of the corpus README file, if it exists.
        """
        ...
    
    def license(self): # -> bytes | Any | str:
        """
        Return the contents of the corpus LICENSE file, if it exists.
        """
        ...
    
    def citation(self): # -> bytes | Any | str:
        """
    ...
    def open(self, file): # -> SeekableUnicodeStreamReader | IO[Any] | GzipFile | BytesIO:
        """
