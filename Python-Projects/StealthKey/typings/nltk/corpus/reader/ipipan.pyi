...
class IPIPANCorpusReader(CorpusReader):
    ...
    @_parse_args
    def sents(self, fileids=..., **kwargs): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
    
    @_parse_args
    def paras(self, fileids=..., **kwargs): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
    
    @_parse_args
    def words(self, fileids=..., **kwargs): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
    
    @_parse_args
    def tagged_sents(self, fileids=..., **kwargs): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
    
    @_parse_args
    def tagged_paras(self, fileids=..., **kwargs): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
    
    @_parse_args
    def tagged_words(self, fileids=..., **kwargs): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
...
class IPIPANCorpusView(StreamBackedCorpusView):
    ...
    def read_block(self, stream): # -> list[Any] | list[list[Any]]:
        ...
