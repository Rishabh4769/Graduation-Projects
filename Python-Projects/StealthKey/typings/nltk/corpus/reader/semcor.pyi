...
class SemcorCorpusReader(XMLCorpusReader):
    ...
    def chunks(self, fileids=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
    ...
    def tagged_chunks(self, fileids=..., tag=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
    ...
    def chunk_sents(self, fileids=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
        :return: the given file(s) as a list of sentences, each encoded
            as a list of chunks.
    ...
    def tagged_sents(self, fileids=..., tag=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
