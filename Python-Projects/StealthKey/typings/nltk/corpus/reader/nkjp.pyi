...
class NKJPCorpusReader(XMLCorpusReader):
    ...
    @_parse_args
    def header(self, fileids=..., **kwargs): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
    ...
    @_parse_args
    def raw(self, fileids=..., **kwargs): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
        Returns words in specified fileids.
        """
        ...
