...
class TaggedCorpusReader(CorpusReader):
    ...
    def tagged_paras(self, fileids=..., tagset=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        """
        :return: the given file(s) as a list of
            paragraphs, each encoded as a list of sentences, which are
...
class CategorizedTaggedCorpusReader(CategorizedCorpusReader, TaggedCorpusReader):
    ...
    def tagged_words(self, fileids=..., categories=..., tagset=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
    
    def tagged_sents(self, fileids=..., categories=..., tagset=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
    
    def tagged_paras(self, fileids=..., categories=..., tagset=...): # -> str | ConcatenatedCorpusView | LazyConcatenation | list[Any] | tuple[()] | Element[str]:
        ...
