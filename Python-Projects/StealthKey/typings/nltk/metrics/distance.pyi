...
3. d(a, c) <= d(a, b) + d(b, c)
"""
def edit_distance(s1, s2, substitution_cost=..., transpositions=...):
    """
...
def edit_distance_align(s1, s2, substitution_cost=...): # -> list[tuple[int, int]]:
    """
...
def binary_distance(label1, label2): # -> float:
...
def jaccard_distance(label1, label2): # -> float:
    """Distance metric comparing set-similarity."""
    ...

def masi_distance(label1, label2): # -> float:
...
def interval_distance(label1, label2): # -> None:
...
def presence(label): # -> Callable[..., float]:
    """Higher-order function to test presence of a given label"""
    ...

def fractional_presence(label): # -> Callable[..., float]:
    ...

def custom_distance(file): # -> Callable[..., Any]:
    ...

def jaro_similarity(s1, s2): # -> float:
    """
...
def jaro_winkler_similarity(s1, s2, p=..., max_l=...): # -> float:
    """
